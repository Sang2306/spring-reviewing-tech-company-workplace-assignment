	...
	<div class="container">
		...
		<div class="row">
			<div class="col bg-light">
				<form action="/ReviewingTechCompanyWorkplace/company/add.html"
					method="POST" id="addCompany" enctype="multipart/form-data">
					<div class="row">
						<div class="col-sm-12 col-md mt-2">
							<div class="input-group">
								...
								<input type="text" name="name" class="form-control"
									placeholder="ABC" aria-label="Tên công ty" required>
							</div>
						</div>
						<div class="col-sm-12 col-md mt-2">
							<div class="input-group">
								...
								<div class="col col-md">
									<div class="custom-control custom-radio custom-control-inline">
										<input type="radio" id="industryField1"
											...
											value="product" required> <label
											class="custom-control-label" for="industryField1">Product</label>
									</div>
									<div class="custom-control custom-radio custom-control-inline">
										<input type="radio" id="industryField2"
											class="custom-control-input" name="industryField"
											value="outsourcing" required> <label
											class="custom-control-label" for="industryField2">Out
											sourcing</label>
									</div>
								</div>
							</div>
					...
					<div class="row mt-4">
						<div class="col-sm-3 my-5">
							<img src="<c:url value='/resources/img/no-image.png'/> " id="companyImg" class="card-img-top border text-center"
								alt="logo công ty">
						</div>
									...
									<div class="input-group mb-3">
										<div class="custom-file">
											<input type="file"
												...
												class="custom-file-label" for="photo">Chọn ảnh</label>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="row my-3 justify-content-center">
						<div class="col text-right my-2">
							<button class="btn btn-primary" type="submit" form="addCompany">
